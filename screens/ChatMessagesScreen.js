...
const ChatMessagesScreen = () => {
  ...
  const fetchMessages = async () => {
    try {
      ...
      showAlert("error", "fetching messages failed!");
    }
  };
  ...
  useEffect(() => {
    const fetchRecepientData = async () => {
      try {
        ...
        showAlert("error","retrieving details");
      }
    };
  ...
  const deleteMessages = async (messageIds) => {
    try {
      ...
      if (response.ok) {
        ...
        showAlert("error","Message Deleted");
      }
    } catch {
      showAlert("error","Retry deleting!");
    }
  };
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1, backgroundColor: "#fff" }}>
              ...
              >
                ...
                <Text
                  style={{
                    textAlign: "right",
                    fontSize: 9,
                    color: item?.senderId?._id === userId ? "#e5e5e5" : "#d1d1d1",
                    marginTop: 5,
                  }}
                >
      ...
      >
        ...
        >
          <Entypo onPress={pickImage} name="camera" size={24} color="#007bff" />
